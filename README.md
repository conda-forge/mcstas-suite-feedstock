...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mcstas-suite-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mcstas-suite-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add mcstas mcstas-core mcstas-data mcstas-mcgui mcstas-vis
# for installing globally
pixi global install mcstas mcstas-core mcstas-data mcstas-mcgui mcstas-vis
```
...
It is possible to list all of the versions of `mcstas` available on your platform:
...
```
pixi search mcstas --channel conda-forge
```
