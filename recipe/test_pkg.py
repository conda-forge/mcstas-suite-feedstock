...
def tests_for_pkg_mcstas():
    ...
    #MCPL test:
    run_instrument_file( 'share/mcstas/resources/examples/Tests_MCPL_etc/Test_MCPL_input/Test_MCPL_input.instr', '-s1000 repeat=1 MCPLFILE=' + conda_prefix_dir + '/share/mcstas/resources/examples/Tests_MCPL_etc/Test_MCPL_input/voutput.mcpl')
